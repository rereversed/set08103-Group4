...
class CountryTest {
    ...
    public void getTopRegionDescending_NotNullTest() {
        try {
            ResultSet resultSet = c.getTopRegionDescending(App.con, "Eastern Europe", 1);
        } catch (Exception e) {
    ...
    public void getTopRegionDescending_NullTest() {
        try {
            ResultSet resultSet = c.getTopRegionDescending(App.con, null, 5);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void getTopRegionDescending_NegativeNTest() {
        try {
            ResultSet resultSet = c.getTopRegionDescending(App.con, "Southern and Central Asia", -1);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
...
/**
    ...
    public void getTopNPopulatedCountries_NotNullTest() {
        try {
            ResultSet resultSet = c.topNPopulatedCountries(App.con, 5);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
...
/**
    ...
    public void getCountryDescending_NotNullTest() {
        try {
            ResultSet resultSet = c.getCountryDescending(App.con);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
...
/**
    ...
    public void getContinentDescending_NotNullTest() {
        try {
            ResultSet resultSet = c.getContinentDescending(App.con, "Europe");
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void getContinentDescending_NullContinentTest() {
        try {
            ResultSet resultSet = c.getContinentDescending(App.con, null);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void topNPopulatedCountriesContinent_NotNullTest() {
        try {
            ResultSet resultSet = c.topNPopulatedCountriesContinent(App.con, "Europe", 5);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void topNPopulatedCountriesContinent_NullContinentTest() {
        try {
            ResultSet resultSet = c.topNPopulatedCountriesContinent(App.con, null, 5);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void countryRegionDescending_NotNullTest() {
        try {
            ResultSet resultSet = c.countryRegionDescending(App.con, "Southern and Central Asia");
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
    ...
    public void countryRegionDescending_NullRegionTest() {
        try {
            ResultSet resultSet = c.countryRegionDescending(App.con, null);
        } catch (Exception e) {
            fail("Exception thrown: " + e.getMessage());
        }
    }
